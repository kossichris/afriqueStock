                    ...
                    <ul className={styles.rightMenu}>
                        <li >
                            <span className="mr-4">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-phone-incoming" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke={colors.primary} fill="none" strokeLinecap="round" strokeLinejoin="round">
