            ...
            <div className="wrapper">
                ...
                <div className="bottom_nav">
                    <div className='img-author mb-3 d-flex flex-row justify-content-evenly'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-right mt-1" width="14" height="14" viewBox="0 0 24 24" strokeWidth="2" stroke="#fff" fill="none" strokeLinecap="round" strokeLinejoin="round">
