        ...
        <>
            <div className="dropdown">
                <button className="dropbtn " style={{ fontSize: page ? '8px' : '13px' }}>{title}
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-down" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke={arrowColor} fill="none" strokeLinecap="round" strokeLinejoin="round">
