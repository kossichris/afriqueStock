                    ...
                    <div className="col-xl-12 col-lg-12 pl-xl-5">
                        <div className="conteneur mt-4">
                            ...
                            <div className="round-container-icon-prime">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-send" width="44" height="44" viewBox="0 0 24 24" strokeWidth="3" stroke={colors.blue_light_3x} fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
