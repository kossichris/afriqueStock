                                    ...
                                    <ul className="pricing-wrapper">
                                        <li data-type="monthly" className="is-visible is-ended">
                                            <div className="pricing-body d-flex flex-column text-center">
                                                ...
                                                <div>
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-plus" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
