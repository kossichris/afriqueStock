                        ...
                        <div className="subscribe d-flex flex-column flex-wrap">
                            ...
                            <div className="d-flex flex-row flex-wrap flex-grow">
                                <div>
                                    ...
                                    <ul>
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-check" width="16" height="16" viewBox="0 0 24 24" strokeWidth="2.5" stroke="#2c3e50" fill="none" strokewinecap="round" strokewinejoin="round">
