                    ...
                    <div className="col-xl-12 col-lg-12 pl-xl-5">
                        <div className="conteneur mt-4">
                            ...
                            <div className="round-container-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-mail" width="44" height="44" viewBox="0 0 24 24" strokeWidth="3" stroke={colors.primary} fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
