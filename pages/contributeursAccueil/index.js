            ...
            <div className="container mt-5">
                <div className="row mt-4">
                    ...
                    <div style={{ width: "100%" }} className="text-center mt-4 mb-5">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-right" width="18" height="18" viewBox="0 0 24 24" strokeWidth="3" stroke="#007bff" fill="none" strokeLinecap="round" strokeLinejoin="round">
