                        ...
                        <div className="col-lg-8">
                            ...
                            <section>
                                <div className="form-group col-md-12 d-flex flex-column justify-content-center">
                                    ...
                                    <p class="add_top_30"><button type="submit" value="Submit" class="btn_2" id="submit-contact" ><span>Ajouter des preuves</span><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
